...
def print_results(results_dic, results_stats_dic, model, 
    ...
    """    
    print("\n\n*** Here is the Results Summary for the CNN Model Architecture", model.upper(), "***")
    ...
    if (print_incorrect_dogs and 
        ...
        print("\nThis is an INCORRECT Dog/NOT Dog Assignment:")
    ...
    if (print_incorrect_breed and 
        ...
        print("\nThis is an INCORRECT Dog Breed Assignment:")
